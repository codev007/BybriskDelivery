...
class PickedDelivery extends StatefulWidget {
  PickedDelivery({Key key}) : super(key: key);
  @override
...
class _PickedDeliveryState extends State<PickedDelivery>
    ...
    return InkWell(
      onTap: () {
        Navigator.of(context)
            .push(FadeRouteBuilder(page: PendingDetails(overview.pincode)));
      },
      child: Container(
        padding:
  ...
  _fetchDeliveries() async {
    try {
      ...
      final response = await http.post(mApiController().pendingWithArea,
